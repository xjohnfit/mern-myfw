...
const Yes = () => {
    ...
    return (
        <div className="flex flex-col justify-center items-center">
            ...
            <div>
                <div className="heart relative top-[70%]">
            ...
            <span className="relative bottom-[-7rem] z-10 mt-[7rem] font-semibold">
                Time since I asked you to be my lil Chantal:
            </span>
            <span className="boxShadowTime relative bottom-[-7rem] z-10 font-bold text-center text-4xl  italic border rounded-md m-3 p-2 ">
                {
